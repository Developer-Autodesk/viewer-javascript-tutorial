...
```
credentials.ConsumerKey =process.env.LMV_CONSUMER || '<replace with your consumer key>';

credentials.SecretKey =process.env.LMV_SECRET || '<replace with your consumer secret>';
```
