...
Results of converting "Customizing Viewer Behavior_v3"
Markdown
...
Upload one of your models to your account and get its URN using the following [web page](http://javalmvwalkthrough-vq2mmximxb.elasticbeanstalk.com/).   <to be changed, Cyrille working on a solution similar to Shiya page + Daniel server>
...
There are some sample files included in [this GitHub tutorial repository](https://github.com/Developer-Autodesk/tutorial-getting.started-view.and.data) if you don't have your own. You can clone or download the reposity.
...
git clone [https://github.com/Developer-Autodesk/workflow-node.js-view.and.data.api.git](https://github.com/Developer-Autodesk/workflow-node.js-view.and.data.api.git)
...
Rename or copy the ./credentials\_.js file into ./credentials.js

    Windows

       copy credentials\_.js credentials.js

    OSX/Linux

       cp credentials\_.js credentials.js
...
If you do not need the model translation workflow on your server, you can skip these steps and continue with the next chapter 'Customizing Viewer Behavior'.

Cyrille working on it tmr

To be done using Philippe's lib code at

[https://github.com/Developer-Autodesk/workflow-gallery-view.and.data.api/blob/master/website/routes/Autodesk.ADN.Toolkit.ViewDataClient.js](https://github.com/Developer-Autodesk/workflow-gallery-view.and.data.api/blob/master/website/routes/Autodesk.ADN.Toolkit.ViewDataClient.js)

the goal is to give steps to modify this sample to use the library to add upload functionality in case people in the workshop needs more than one file or wants to automate things

otherwise they can jump directly to the client javascript steps



## Customize the Viewer Behavior

Now you've got a basic 3D model displayed on your webpage, let's customize the viewer behavior. The simplest way to customize behavior is through the Extension mechanism. Extensions allow you to encapsulate your customized behavior in a separate JavaScript file that you can 'load' into the viewer when it's running (you can unload it whenever you like too).
...
? Visit the Autodesk Developers Page and log in with your Autodesk Account.
...
with a Windows .Net WPF application

or with a Swift Mac OS application

There are some sample files included in this GitHub tutorial repository if you don't have your own. You can clone or download the reposity.

If you have github client( GitHub for Windows or GitHub for Mac) installed, you can clone the tutorial repository from github.com. Go to https://github.com/Developer-Autodesk/tutorial-getting.started-view.and.data and clone the source code by click the "Clone in Desktop" button.
...
Install Node.js
If you want to run the preconfigured local web-server and the test tools then you will also need Node.js v0.12.2+.

You can download a Node.js installer for your operating system from http://nodejs.org/download/. Check the version of Node.js that you have installed by running the following command:
...
If you have github client( GitHub for Windows or GitHub for Mac) installed, you can clone the source code from github.com. Go to https://github.com/Developer-Autodesk/workflow-node.js-view.and.data.api and clone the source code by click the "Clone in Desktop" button.
...
https://github.com/Developer-Autodesk/workflow-gallery-view.and.data.api/blob/master/website/routes/Autodesk.ADN.Toolkit.ViewDataClient.js
...
(If you don't want to type the code, you cancopy the finished files for each step from the subfolders in the GitHub repository, which was cloned or downloaded when preparing the models.)
...
Note: If you copy the modified index.js file from the Step 3 folder in the tutorial repository, make sure you edit the defaultURN on line 18 to use the URN of the translated file you created at the beginning of the tutorial.

Step 4 – Testing the extension
Your barebones extension should be ready to run now. All it does is display an alert when it's loaded. Test that the extension is loaded properly by running your sample. (Remember that you setup your node.js project to serve the client page to http://localhost:3000/, so open your WebGL-enabled browser and type that address in the address bar). Since all our changes are on client side, you can just refresh your browser to test your changes.
...
http://adndevblog.typepad.com/cloud_and_mobile/2015/04/how-to-create-animations-in-the-viewer.html
...
https://www.youtube.com/watch?v=SQJSuqRqiCg

https://www.youtube.com/watch?v=tK2ndbvchIM
